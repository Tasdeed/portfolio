      ...
      <div className="max-w-[1440px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            to utilize the ease of routing for Next.js (creating different
            routes for each chat) and the power of real-time database/
            authentication of Firestore (authenticating through Google and
            receiving/ sending messages immediately).
          </p>
